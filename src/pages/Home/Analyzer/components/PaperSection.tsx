...
function PaperSection({ setSelectedHalf, selectedPage, selectedHalf, bottomRef, processor, output, allOutputsRef }: OutputProps) {
    ...
    const shouldShowLock = !userInfo && !processor.gettingOutput && !processor.streaming && allOutputsRef.current && !output
    console.log(shouldShowLock)
